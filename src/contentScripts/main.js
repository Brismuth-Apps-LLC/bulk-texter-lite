...
const selectors = {
	...
	gvStartChatButton: 'gv-contact-list div[ng-class="::ctrl.Css.SEARCH_LIST"] div[ng-class="::ctrl.Css.SEND_TO_PHONE_NUMBER"], gv-contact-list div[ng-class="::ctrl.Css.SEARCH_LIST"] div[ng-class="[\'md-body-1\', ctrl.Css.SEND_TO_PHONE_NUMBER]"]',
	...
	gvSendButton: 'gv-icon-button-ng2[icon-name="send"][label="Send message"] button, gv-icon-button[icon-name="send"] button[aria-label="Send message"]',
